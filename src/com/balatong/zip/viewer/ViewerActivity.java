	...
	private void readZipFile(Intent intent) {
		...
		if (!file.isFile()) {
			logger.debug("Path " + file.getAbsolutePath()
					+ " is not a valid file.");
			statusBar.setText(getString(R.string.err_not_valid_zip_file, file.getAbsolutePath()));
			return;
		}
		reader = createReader();
		reader.execute(file);
					...
					public void onClick(DialogInterface dialog, int which) {
						...
						ContentsExtractor extractor = new ContentsExtractor() {
							protected void onPreExecute() {
								...
								activityBar.setVisibility(ProgressBar.VISIBLE);
								statusBar.setText(getResources().getString(R.string.extracting_files));
							...
							protected void onPostExecute(Integer result) {
								super.onPostExecute(result);
								activityBar.setVisibility(ProgressBar.INVISIBLE);
								statusBar.setText(getResources().getString(R.string.extracted_num_files, result));
							...
							protected void onProgressUpdate(String... values) {
								...
								statusBar.setText(getResources().getString(R.string.extracting_file, values[0]));
